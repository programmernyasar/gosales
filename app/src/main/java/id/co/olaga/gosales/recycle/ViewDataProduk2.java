...
public class ViewDataProduk2 extends AppCompatActivity {
    ...
    private String stockCategory1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.view_data_produk2);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Produk");

        Bundle dataExtra = getIntent().getExtras();
        stockCategory1 = dataExtra.getString("kirimtype");
        ...
        adapter = new RecyclerViewAdapter2(NamaList);
    ...
    protected void getData(){
        ...
        Cursor cursor = ReadData.rawQuery("SELECT DISTINCT "+ AppVar.TAG_STOCK_CATEGORY2 + " FROM produk WHERE "+
                AppVar.TAG_STOCK_CATEGORY1 +" = '"+ stockCategory1+ "'",null);
